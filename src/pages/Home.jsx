...
const Home = () => {
  ...
  return (
    <>
      ...
      <main className={`relative bg-[#000000] text-white selection:bg-white selection:text-black font-sans antialiased cursor-none ${loading ? 'h-screen overflow-hidden' : ''}`}>
