...
// FIXED: Added AnimatePresence to the imports to resolve the crash!
    ...
    >
      ...
      <div className="overflow-hidden mb-8 relative z-10 px-4 text-center">
        <motion.h1 
          ...
          className="text-4xl sm:text-6xl md:text-7xl font-bold tracking-[0.3em] sm:tracking-[0.5em] uppercase text-transparent outline-text-preloader leading-tight"
        >
          ANAS KHAN
        </motion.h1>
      </div>
...
// 3. Heavy Magnetic Button Wrapper
...
const Services = () => {
  ...
  return (
    <>
      ...
      <main ref={containerRef} className={`relative bg-[#000000] text-white selection:bg-teal-500/30 overflow-hidden font-sans antialiased cursor-auto md:cursor-none ${loading ? 'h-screen overflow-hidden' : ''}`}>
        ...
        <div className="max-w-[1920px] mx-auto px-4 sm:px-10 md:px-20 lg:px-28 relative z-10 pt-32 sm:pt-48 pb-32 sm:pb-48">
          ...
          >
            ...
            <div className="overflow-hidden pb-2 sm:pb-4 w-full">
            ...
            <div className="overflow-hidden pb-4 sm:pb-8 w-full">
          ...
          <div className="grid lg:grid-cols-12 gap-16 lg:gap-32 items-start mt-10 sm:mt-20">
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} className="lg:col-span-5 lg:sticky lg:top-40">
